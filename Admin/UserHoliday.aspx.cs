...
public partial class Admin_UserHoliday : System.Web.UI.Page
{
    ...
    private void LoadData(string userid, string username)
    {
        ...
        userBll.Asp_Holiday(this.GridView1, this.AspNetPager1, userEntity);
    }
    ...
    {
        base.Response.Redirect("UserHolidayDetailManage.aspx?id=" + e.CommandArgument + "&type=2");
    }
}