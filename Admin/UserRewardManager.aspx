<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="UserRewardManager.aspx.cs" Inherits="Admin_UserWrongManager" %>
                ...
                <asp:DataList ID="DataList1" runat="server" Width="100%">
                    <ItemTemplate>
                        <table cellpadding="0" cellspacing="0" class="infolist_vt" style="width: 100%">
                            ...
                            <tr>
                                <td class="common" colspan="2" style="padding-left:30%"><a class="thickbox" href='UserRewardBack.aspx?height=300;width=600&amp;id=<%#Eval("RewardProblemID") %>&amp;type=1'>认同加分</a> <a class="thickbox" href='UserRewardBack.aspx?height=300;width=600&amp;id=<%#Eval("RewardProblemID") %>&amp;type=2'>不认同加分</a>
