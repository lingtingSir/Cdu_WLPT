...
public partial class Admin_HolidayBack : System.Web.UI.Page
{
    ...
    private void SetTextBoxText()
    {
        ...
        {
            this.txtDes.Text = "谢谢您的上报，我们为您加5分";
            return;
        }
        if (base.Request.QueryString["type"].ToString() == "2")
        {
            this.txtDes.Text = "谢谢您的上报，我们不给你加分";
            return;
        }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (base.Request.QueryString["type"].ToString() == "1")
        {
            ...
            if (byID2 != null && byID2.Rows.Count == 1)
            {
                ...
                userIntegralDetailEntity.ChangeDes = "认同上报";
        ...
        else
        {
            ...
            if (byID3 != null && byID3.Rows.Count == 1)
            {
                ...
                userIntegralDetailEntity2.ChangeDes = "不认同上报";
