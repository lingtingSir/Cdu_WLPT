<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="ProjectInternetion.aspx.cs" Inherits="Admin_ProjectInternetion" %>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" Width="100%"
                        ...
                        <Columns>
                          ...
                          <asp:TemplateField HeaderText="项目编号">
                           ...
                           <asp:TemplateField HeaderText="发包用户">
                                <ItemTemplate>
                                    <center>
                                        <asp:Label ID="lbName3" runat="server" Text='<%#Eval("ClientID") %>'></asp:Label>
                                    </center>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="修改">
                              <ItemTemplate>
                                 <center>
                                  <a href='EditorProjectPaper.aspx?height=460;width=600&PPID=<%#Eval("PPID") %>' class="thickbox">修改</a>
                                 </center>
                            ...
                            <ItemTemplate>
                            <center>
                            <a href='ProjectPaperView.aspx?height=460;width=600&PPID=<%#Eval("PPID") %>' class="thickbox">查看描述</a>
                            </center>
                            </ItemTemplate> 
                            </asp:TemplateField>
