...
public partial class Users_ProjectInternetion : System.Web.UI.Page
{
    ...
    protected void LoadData(int PPID, string Name)
    {
        ...
        if (byID != null && byID.Rows.Count == 1)
        {
            ...
            projectPaperEntity.DepartmentId = Convert.ToInt32(byID.Rows[0]["DepartmentId"]);

        }
        projectPaperEntity.PPID = PPID;
        projectPaperEntity.Name = Name;
        projectPaperBll.Asp666(this.GridView1, this.AspNetPager1, projectPaperEntity);
    }
    ...
    {
        base.Response.Redirect("UserRecordManage.aspx?id=" + e.CommandArgument);
    }
