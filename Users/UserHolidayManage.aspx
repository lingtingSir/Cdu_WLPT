<%@ Page Title="" Language="C#" MasterPageFile="~/Users/User.master" AutoEventWireup="true" CodeFile="UserHolidayManage.aspx.cs" Inherits="Users_UserHolidayManage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table cellpadding="0" cellspacing="0" class="infolist_vt">
        ...
        <tr>
            ...
            <td class="common">
                    &nbsp;
                    <a href='UserHolidayDes.aspx?height=350;width=500' class="thickbox">添加请假</a>
                </td>
       </tr> 
        <tr>
            <td>
