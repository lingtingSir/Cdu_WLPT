<%@ Page Title="" Language="C#" MasterPageFile="~/Contact/Contact.master" AutoEventWireup="true" CodeFile="EditorProjectPaper.aspx.cs" Inherits="Contact_EditorProjectPaper" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script  type="text/javascript" src="../My97DatePicker/WdatePicker.js" ></script> 
        ...
        <tr><td colspan="2" class="common">
             <FCKeditorV2:FCKeditor ID="txtDes" runat="server" > 
                            </FCKeditorV2:FCKeditor>
            </td></tr>
            <tr><td class="common" colspan="2">&nbsp;&nbsp;<asp:Button CssClass="button" 
                    ID="addPaper" runat="server" Text="添加" onclick="addPaper_Click" ValidationGroup="1" />
                &nbsp;&nbsp; 
